 ...
 * Background: looping video fixed to viewport (hero-comp.mp4).
 * iOS-compatible: <source type="video/mp4">, preload, GPU-layer hint.
 * Scroll: GSAP fades hero content to black as user leaves section.
 */
...
export default function Hero() {
  ...
  return (
    <>
      {/* ── Fixed video backdrop — locked to viewport, behind everything ── */}
      <div
        style={{
          position: "fixed",
          inset: 0,
      ...
      >
        <video
          ...
          style={{
            ...
            height: "100%",
            objectFit: "cover",
            /* Force GPU compositing layer — prevents iOS black-screen flash */
      ...
      {/* ── Hero section — sits above the fixed video ── */}
      <section
        ref={sectionRef}
        className="relative h-screen flex flex-col items-center justify-center overflow-hidden"
        style={{ zIndex: 1 }}
      >
        {/* ── Scroll fade-to-black — absolute so it's clipped to the hero ── */}
        <div
          ref={overlayRef}
