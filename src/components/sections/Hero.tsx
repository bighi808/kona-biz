/**
 * Hero — full-viewport intro for the homepage.
 * Ported from konabiz-lander.html lines 1568-1586.
 * Uses public/hero-image1.jpg as the parallax background.
 */
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center text-center px-8 py-32 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(8,8,7,0.82) 0%, rgba(8,8,7,0.70) 40%, rgba(8,8,7,0.80) 70%, rgba(8,8,7,0.92) 100%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <p className="font-serif italic text-muted-foreground mt-8 mb-14 max-w-xl mx-auto leading-relaxed rise-up rise-up-delay-2"
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-16 rise-up rise-up-delay-3">
          <span className="text-[10px] tracking-[0.25em] uppercase text-gold border border-gold/30 px-4 py-2">
            One Client Per State
          </span>
          <span className="text-[10px] tracking-[0.25em] uppercase text-muted-foreground border border-border px-4 py-2">
            SEO + GEO
          </span>
          <span className="text-[10px] tracking-[0.25em] uppercase text-muted-foreground border border-border px-4 py-2">
            Custom Web
